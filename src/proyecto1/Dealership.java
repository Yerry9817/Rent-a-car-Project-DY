            ...
            switch (opc) {
                ...
                case 4:
                    ...
                    if (Brand != null) {
                        ...
                        //ejecuta el metodo de buscar pero enviando solo el dni y no toda la info como estaba antes
                        var existCustomer = C.findCustomer(DNI, customer);
                        
                        //si el metodo de buscar no devuelve true
                        if (!existCustomer) {
                            //if custumer doesnt exist, add
                            C.addCustomer(DNI, Name, lastName ,customer);
                            C.printCustomer(customer);
                        }
                    ...
                    break;
                case 5:
                    System.out.println("Generate report of all rentals cars");
                ...
                case 8:
                    ...
                    System.out.println("Write your LastNamee");
                    ...
                    var existCustomer = C.findCustomer(identificacionComprador, customer);
